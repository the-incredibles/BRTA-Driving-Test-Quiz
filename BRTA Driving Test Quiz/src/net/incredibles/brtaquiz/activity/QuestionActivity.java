...
public class QuestionActivity extends RoboActivity {
    ...
    private void displaySignImage(Question question) {
        if (question.getSignSet().getId() != 6) {
    ...
    private void displayAnswers(Question question) {
        ...
        for (Answer answer : answers) {
            ...
            if (question.getSignSet().getId() == 6) {
                addCheckbox(answer.getId(), sign.getImage(), answer.isMarked());
            } else {
    ...
    private void addCheckbox(int signId, byte[] signImage, boolean checked) {
        View inflate = layoutInflater.inflate(R.layout.checkbox, null);

        CheckBox checkBox = (CheckBox) inflate.findViewById(R.id.checkbox);
        ImageView imageView = (ImageView) inflate.findViewById(R.id.checkbox_img);

        checkBox.setId(signId);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                questionController.updateCheckboxAnswer(checkBox.getId(), checkBox.isChecked(), false);
            }
        });

        imageView.setImageBitmap(BitmapFactory.decodeByteArray(signImage, 0, signImage.length));
