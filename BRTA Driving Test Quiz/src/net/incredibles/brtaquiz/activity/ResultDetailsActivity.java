...
public class ResultDetailsActivity extends RoboActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (Result result : resultList) {
            ...
            TextView marksTextView = (TextView) resultDetailsEntryView.findViewById(R.id.marks);
            ...
            marksTextView.setText(Integer.toString(ResultController.getObtainedMarks(result.getCorrect(), result.getAnswered())));
