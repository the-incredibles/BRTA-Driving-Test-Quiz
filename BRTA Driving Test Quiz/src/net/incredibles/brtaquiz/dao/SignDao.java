...
public interface SignDao {
    ...
    List<Sign> getRandomSignsForSignRecognitionSet(long limit);

    List<Sign> getRandomSigns(SignSet signSet, long limit);

    List<Sign> getRandomSignsExcluded(SignSet excludedSignSet, long limit);
